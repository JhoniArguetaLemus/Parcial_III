<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Administracion.aspx.cs" Inherits="Parcial_III.Administracion1" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
 <head runat="server">
     <link rel="shortcut icon" href="images/administrador.ico" />
...
<body class="body-administracion">
  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="navbarTogglerDemo01">
        ...
        <h3 class="nav-brand"><a class="nav-link active link-light" href="Administracion.aspx">Administración</a></h3>
      <ul class="navbar-nav d-flex justify-content-center align-items-center bg-gray">

         <li class="nav-item">
          <a class="nav-link active link-light " aria-current="page" href="Registro.aspx">Registro</a>
        </li>
