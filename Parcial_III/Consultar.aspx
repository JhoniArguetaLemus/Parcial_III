<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Consultar.aspx.cs" Inherits="Parcial_III.Administracion" %>
...
<body>
  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="navbarTogglerDemo01">
     ...
     <h3 class="nav-brand"><a class="nav-link active link-light" href="Consultar.aspx">Consultar</a></h3>

      <ul class="navbar-nav d-flex justify-content-center align-items-center bg-gray">

           <li class="nav-item">
          <a class="nav-link active link-light " aria-current="page" href="Registro.aspx">Registrar</a>
        </li>
    ...
    <form id="form1" runat="server">
        ...
        <div class="form-inicio">
            ...
            <asp:UpdatePanel ID="UpdatePanel" UpdateMode="Conditional" runat="server" >
                <ContentTemplate>
                    <asp:GridView ID="GVConsultar" runat="server" AutoGenerateColumns="False" BackColor="#CCCCCC" BorderColor="#999999" BorderStyle="Solid" BorderWidth="3px" CellPadding="4" CellSpacing="2" ForeColor="Black" OnRowCommand="gv_Lista_RowCommand" DataKeyNames="Id" OnSelectedIndexChanged="GVConsultar_SelectedIndexChanged" >
                        <Columns>
